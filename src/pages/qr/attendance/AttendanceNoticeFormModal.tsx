...
export function AttendanceNoticeFormModal({
  ...
  const submit = async () => {
    ...
    try {
      ...
      Alert.alert("Aviso enviado", "Tu jefe inmediato y RH ya fueron notificados. RH valorará el motivo en incidencias.", [
        { text: "OK", onPress: () => {
          onSubmitted?.(notice);
          onClose();
        }},
        ...
        <View style={styles.sheet}>
          <View style={styles.header}>
            ...
            <Pressable onPress={onClose} hitSlop={12} accessibilityLabel="Cerrar">
              <CloseCircle size={24} color={COLORS.muted} variant="Bold" />
            </Pressable>
          </View>
          ...
          {loadingExisting ? (
            ...
            >
              <Text style={styles.hint}>
                Avisa a primera hora, antes de tu hora de entrada, para que tu jefe pueda cubrir el turno. RH valorará el motivo.
              </Text>
